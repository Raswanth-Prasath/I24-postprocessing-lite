...
def main():
    ...
    # Also train models with consensus top-5-15
    consensus_top5 = consensus_df.head(5)['feature'].tolist()
    consensus_top6 = consensus_df.head(6)['feature'].tolist()
    consensus_top7 = consensus_df.head(7)['feature'].tolist()
    ...
    train_optimal_model(X, y, feature_names, consensus_top5, "consensus_5features_full47")
    train_optimal_model(X, y, feature_names, consensus_top6, "consensus_6features_full47")
    train_optimal_model(X, y, feature_names, consensus_top7, "consensus_7features_full47")
