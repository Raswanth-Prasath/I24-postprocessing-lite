...
def main():
    ...
    parser.add_argument('--dataset', default='Logistic Regression/training_dataset_advanced.npz',
    ...
    # Train model
    lr = LogisticRegression(max_iter=1000, solver='lbfgs', C=args.C)
    ...
    logits_test = lr.decision_function(X_test)
